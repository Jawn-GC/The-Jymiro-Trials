meta = {
    name = 'The Jymiro Trials',
	description = "14 levels based on the levels from 'The Kymiro Trials'",
    version = '1.0',
    author = 'JawnGC',
}
...
--Levels
local l1 = require("ups_and_downs")
local l2 = require("tight_spaces")
local l3 = require("temperature_rising")
local l4 = require("eruption")
local l5 = require("in_a_prickle")
local l6 = require("guardian_angel")
local l7 = require("rocky")
local l8 = require("ascension")
local l9 = require("crush_on_you")
local l10 = require("sokoban")
local l11 = require("invasion")
local l12 = require("pokemon")
local l13 = require("water_level")
local l14 = require("memories")
local ending = require("ending")

--Set level order
levels = {l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, ending}
...
define_tile_code("skelekey")
set_pre_tile_code_callback(function(x, y, layer)
	local block_id = spawn_entity_snapped_to_floor(ENT_TYPE.ITEM_PICKUP_SKELETON_KEY, x, y, layer, 0, 0)		
	return true
end, "skelekey")
